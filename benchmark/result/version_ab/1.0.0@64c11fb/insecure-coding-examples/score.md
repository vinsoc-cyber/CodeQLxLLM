...
Model `ollama/gpt-oss:120b` · temp `0` · panel `sha256:9cdeda155…` · 2026-08-13T16:28:13

precision **90%** · recall **100%** · TP 29 (real 26, false-alarm 3) · real 26 · not-real 6 · NMD 2 · err 0 · $0.0
_resources:_ 153k in / 44k out · cache 0% · 739.0s model-time · iters μ1.31
...
| cpp/static-buffer-overflow@practice/if_constexpr.cpp:15 | real | TP | CORRECT | Low |
| cpp/suspicious-sizeof@practice/decay.cpp:5 | not-real | NMD | abstain | Medium |
...
| cpp/type-confusion@practice/guidelines/expressions_and_statements/use_named_cast.cpp:16 | not-real | NMD | abstain | Low |
